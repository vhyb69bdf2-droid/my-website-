  ...
  function listenForGroupRoom() {
    ...
    const off = roomRef.on("value", snap => {
      ...
      if (state.groupType === "battle" && data.phase === "overtimeLock") {
        ...
        document.getElementById("groupSecretPanel").style.display = isTied && !state.myLocked ? "grid" : "none";
        document.getElementById("groupSecretLocked").style.display = isTied && state.myLocked ? "block" : "none";
        document.getElementById("groupGameArea").style.display = "none";
